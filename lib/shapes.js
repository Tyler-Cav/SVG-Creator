...
class Circle extends Shape {
    ...
    <text text-anchor="middle" font-size="60" x="50" y="60" fill="${this.textColor}" >${this.text}</text>
    </svg>`;}
}
...
class Triangle extends Shape {
    ...
    <text text-anchor="middle" font-size="60" x="150" y="120" fill="${this.textColor}" >${this.text}</text>
    </svg>`;}
}
